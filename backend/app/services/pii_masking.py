"""Deterministic PII detection and masking service.

This service preserves the frozen v0.2.1 PR-3 detection and masking rules.
It does not use external services or third-party packages, and it never
stores detected raw values in the result object.
"""
